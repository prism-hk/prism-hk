        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-8">
          {CATEGORIES.map((cat) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 rounded-full border-2 border-[#1E1B3A]/15 flex items-center justify-center group-hover:border-[#7B68EE] group-hover:bg-gray-100 group-hover:scale-105 transition-[transform,border-color,background-color]">
